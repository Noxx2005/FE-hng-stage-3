...
- Location: tests\e2e\app.spec.ts:115:7
...
Locator: locator('text=Persistent Habit')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Persistent Habit')
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e15]:
    - generic [ref=e16]:
      ...
      - generic [ref=e18]: Sign in to your account
    - generic [ref=e19]:
      - generic [ref=e20]:
        - generic [ref=e21]:
...
> 135 |     await expect(page.locator('text=Persistent Habit')).toBeVisible();
  ...
  175 | 
  176 |     // Go back online
  177 |     await page.context().setOffline(false);
  178 |   });
  179 | });
  180 | 
```